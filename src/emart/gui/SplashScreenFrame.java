...
public class SplashScreenFrame extends javax.swing.JFrame {
    ...
    public SplashScreenFrame() {
        ...
        splshthread sp = new splshthread();
        sp.start();
...
//        System.out.println(jProgressBar1.getValue());
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/emart/img/supermarket.jpg"))); // NOI18N
    ...
    class splshthread extends Thread {
        ...
        public void run() {
            ...
            while (jProgressBar1.getValue() < jProgressBar1.getMaximum()) {
                try {
                    ...
                    JOptionPane.showMessageDialog(null, "Threas Intrrupted");
                    e.printStackTrace();
                }
            }
